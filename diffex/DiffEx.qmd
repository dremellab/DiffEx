...
params:
  ...
  output_dir: "~/Desktop/250427/results_250427"
...
if (isTRUE(params$useERCC)) {
  ...
  if (num_ercc == 0) {
    stop("❌ No genes starting with 'ERCC' were found in the counts matrix.")
  } else {
    print(glue::glue("🧪 ERCC scaling selected: Found ", num_ercc, " ERCC spike-in genes."))
  }
}

# Identify ERCC genes
ercc_rows <- grep("^ERCC", rownames(filtered_counts))
if (length(ercc_rows) == 0) stop("❌ No ERCC spike-ins found in the counts matrix.")
...
if (isTRUE(params$useERCC)) {
  print(glue::glue("🧪 ERCC scaling/TMM normalization will be applied"))
  ...
  print(glue::glue("📏 TMM normalization selected"))
...
print(glue::glue("🔍 Filtered out ", sum(!keep_genes), " genes using CPM filtering. "))
...
print(glue::glue("✅ Remaining genes for edgeR analysis: ", remaining))
...
```{r setupdeseq2}
#| code-fold: true
#| code-summary: "🧬 Set up DESeq2 object"
#| message: true
#| warning: false
#| echo: false
